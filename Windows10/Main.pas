...
begin
    ...
    // se a porta estiver aberta, inicia a variação de pedidos
...
begin
  ...
  if SpeedButtonConecta.Caption = LABEL_CONNECTED then begin
      ...
      StatusBar.Panels.Items[BARRA_CONEXAO].Text := 'Buscando conexão';
  end
  // é para desconectar
  else begin
...
begin
  ...
  StatusBar.Panels.Items[BARRA_CONEXAO].Text := 'Falha na conexão';

  // liga o timer de reconexão
...
// ******************************
// verifica se o valor digitado é tipo float
